...
def print_numbered_drinks(drinks):
    for i, drink in enumerate(drinks, start=1):
        print("{}) {} дата изг.: {}".format(i, drink.title, drink.production_date))
...
beer5 = Beer(title="Carlsberg")
beer6 = Beer(production_date="2022-01-09")

market = Market(wines=[wine1, wine2, wine3, wine4, wine5], beers=[beer1, beer2, beer3, beer4, beer5, beer6])
market2 = Market()
...
print_numbered_drinks(sorted_drinks)
...
print_numbered_drinks(filtered_drinks)
